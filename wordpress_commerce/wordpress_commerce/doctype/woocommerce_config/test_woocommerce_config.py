...
from wordpress_commerce.sync_orders import create_order, valid_customer_and_product
from wordpress_commerce.sync_products import update_item_stock
from wordpress_commerce.sync_customers import create_customer
from erpnext.stock.utils import get_bin

class WooCommerceSettings(unittest.TestCase):
	def setUp(self):
		frappe.set_user("Administrator")
		sync_fixtures("wordpress_commerce")
